...
image1=cv2.imread('Images/lampshade_L.png')
image2=cv2.imread('Images/lampshade_R.png')
...
cv2.imwrite('Results/sift1.jpg',Image1Keypoints)
Image2Keypoints=cv2.drawKeypoints(image2,keypointsImage2,None)
cv2.imwrite('Results/sift2.jpg',Image2Keypoints)
...
cv2.imwrite('Results/epi_right.jpg',image2Final)
cv2.imwrite('Results/epi_left.jpg',image1Final)
...
plt.imsave('Results/disparity.jpg',disparity, cmap='turbo_r')
